...
Conduct linear regression between two variables that have strong, significant correlation (e.g., chl-a and secchi in Tarawera). then the challenge will be to conduct linear regression between two different variables (e.g., TN and chl-a)
